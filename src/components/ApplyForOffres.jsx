  ...
  return (
    <>
        ...
        <div className="fixed inset-0 w-full h-full flex justify-center items-center backdrop-brightness-50 ">
          <div className="w-[350px] p-4 bg-white rounded-lg">
            <p className="text-center">
              Would you like to apply for this offer?
            </p>
      ...
      <div className="w-full h-full flex justify-center visible-section ">
        <div
          className="gb-popup-bounce-to-bottom hidden fixed top-2 bg-white w-[350px] rounded-xl py-2 px-4 border border-gray-400 "
          id="applyMsg"
        >
          <svg
          ...
          You have applied for this offer, and your folder will be handled by
          the companie staff, <strong>we will notif</strong> you with the latest
          modifications.
        </div>
      </div>
    </>
