...
function Interactions( {offer} ) {    
  ...
  return (
    <>
        <div className='flex items-center gap-1' onClick={handelLikes}>
            ...
            <p className={`font-semibold`}>{interaction.like > 9999 ? interaction.like.toString().slice(0,2) + 'k' : interaction.like > 999 ? interaction.like.toString().at(0) + 'k': interaction.like}</p>
        </div>
        <div className='flex items-center gap-1' onClick={handelShares}>
            ...
            <p className={`font-semibold`}>{interaction.share > 9999 ? interaction.share.toString().slice(0,2) + 'k' : interaction.share > 999 ? interaction.share.toString().at(0) + 'k': interaction.share}</p>
        </div>
        <div className='flex items-center gap-1' onClick={handelHires}>
